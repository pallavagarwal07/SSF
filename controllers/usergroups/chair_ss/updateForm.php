...
if (mysqli_query($conn, $query) == TRUE) {
    echo "<script>alert('Form Updated by Executive');window.location.href='../../../views/usergroups/chair_ss/viewForms.php';</script>";
} else {
    echo "<script>alert('Executive Unable to Update Form!');window.location.href='../../../views/usergroups/chair_ss/viewForms.php';</script>";
}
mysqli_close($conn);
?>
