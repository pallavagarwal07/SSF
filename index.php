...
<body>
    <div id="container" class="col-lg-8" style="margin:30px;">
        ...
        <form method="post" class="form-group">
            ...
            <button type="submit" class="btn btn-default btn-info" formaction="./controllers/register.php">Register</button>
        </form>
    </div>
</body>
</html>
